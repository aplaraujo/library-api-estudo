package io.github.aplaraujo.library_api_estudo.repositories.specs;
...
public class LivroSpecs {
    ...
    public static Specification<Livro> anoPublicacaoEqual(Integer anoPublicacao) {
        return ((root, query, criteriaBuilder) ->
                criteriaBuilder.equal(criteriaBuilder.function("to_char", String.class, root.get("dataPublicacao"), criteriaBuilder.literal("YYYY")),
    ...
    public static Specification<Livro> nomeAutorLike(String nome) {
        return ((root, query, criteriaBuilder) -> {
            Join<Object, Object> objectJoin = root.join("autor", JoinType.INNER);
            return criteriaBuilder.like(criteriaBuilder.upper(objectJoin.get("nome")), "%" + nome.toUpperCase() + "%");
